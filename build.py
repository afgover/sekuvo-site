...
FONTS = {
    ...
    "cyrillic": ("https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:wght@400;500;600;700"
                 ...
                 '"IBM Plex Sans", system-ui, sans-serif'),
    # Urdu readers expect Nastaliq calligraphic shaping, not the Naskh style
    # IBM Plex Sans Arabic renders — a dedicated face, unlike the shared
    # "arabic" bucket which Arabic's Naskh convention is happy with.
    "urdu": ("https://fonts.googleapis.com/css2?family=Noto+Nastaliq+Urdu:wght@400..700"
             "&family=IBM+Plex+Mono:wght@400;500&display=swap",
...
L["ur"] = dict(
    lang="ur", dir="rtl", script="urdu", path="ur/", name="اردو",
    title="Sekuvo — آپ کا محفوظ والٹ",
    desc="Sekuvo — آپ کا محفوظ والٹ۔ اینڈرائیڈ کے لیے مکمل طور پر آف لائن پاس ورڈ والٹ: بغیر انٹرنیٹ اجازت کے، AES-256، اوپن سورس (GPLv3)۔",
    nav=("سیکیورٹی", "چینلز", "ڈاؤن لوڈ", "رازداری"),
    eyebrow="اینڈرائیڈ کے لیے آف لائن پاس ورڈ والٹ",
    h1="آپ کے راز<br>کبھی <em>باہر نہیں جاتے۔</em>",
    lede="Sekuvo آپ کا محفوظ والٹ ہے: پاس ورڈز، کارڈز اور نوٹس، آپ کے فون پر ایک ایسی کلید سے مرمز جسے صرف آپ کا ماسٹر پاس ورڈ حاصل کر سکتا ہے۔ نہ سرور، نہ اکاؤنٹ، نہ سنک — اور کسی کو بتانے کا کوئی طریقہ نہیں۔",
    btn_src="GitHub پر سورس کوڈ", btn_priv="رازداری کی پالیسی",
    cta_note="Google Play کی فہرست تیار ہو رہی ہے۔ Sekuvo مفت اور GPLv3 کے تحت ہے — کوڈ ہی ثبوت ہے۔",
    proof_cap="AndroidManifest.xml — اس کی تمام اجازتیں",
    proof_alt="ایپ کا مینی فیسٹ کیمرہ، بایومیٹرک اور بلوٹوتھ مانگتا ہے، اور INTERNET اجازت کی تلاش کوئی نتیجہ نہیں دیتی۔",
    proof_no="(کوئی نتیجہ نہیں — یہ اجازت موجود ہی نہیں)",
    sec_eyebrow="سیکیورٹی ماڈل",
    sec_h2="ایسی خفیہ کاری جسے آپ جانچ سکتے ہیں، ماننا نہیں پڑتا۔",
    sec_kicker="ہر حساس فیلڈ AES-256-GCM سے سیل کی جاتی ہے۔ کلید کبھی کسی سرور کو نہیں چھوتی کیونکہ کوئی سرور موجود ہی نہیں؛ یہ آپ کے فون پر، آپ کے ماسٹر پاس ورڈ سے، ہر بار تالا کھولنے پر حاصل کی جاتی ہے۔",
    chain=CHAIN_LATIN,
    cells=[("اسکرین بند ہوتے ہی لاک ہو جاتا ہے",
            "اسکرین بند ہوتے ہی کلید میموری سے مٹا دی جاتی ہے — فولڈ ایبل فون بند کرنا بھی اس میں شامل ہے۔ ایک ہی تالا کھلنا ایپ، کی بورڈ اور آٹو فل تینوں کو ایک ساتھ خدمت دیتا ہے۔"),
           ("بیک اپس جو فون سے زیادہ عرصہ چلتے ہیں",
            "ایک مرمز <span class=\"mono-note\">.vaultbak</span> فائل، جہاں آپ چاہیں محفوظ کریں۔ فائل اور بیک اپ پاس ورڈ مل کر کسی بھی ڈیوائس پر سب کچھ بحال کر دیتے ہیں — بحالی کا راستہ شروع سے آخر تک آزمایا ہوا ہے۔"),
           ("بحالی کا کوئی پچھلا دروازہ نہیں",
            "ماسٹر پاس ورڈ بھول جائیں تو ڈیٹا ختم ہو جاتا ہے۔ یہ جان بوجھ کر ایسا ہے: ایک دروازہ جسے صرف آپ کھول سکتے ہیں اس کے نیچے کوئی چھپی ہوئی اضافی کلید نہیں ہوتی۔")],
    ch_eyebrow="ڈیزائن کے مطابق بغیر کلپ بورڈ کے",
    ch_h2="تین راستے، سب آپ کی انگلی کی پہنچ میں۔",
    ch_kicker="کلپ بورڈ وہ جگہ ہے جہاں راز چوری ہوتے ہیں۔ اسی لیے Sekuvo قدریں براہ راست منزل میں ٹائپ کرتا ہے۔",
    lanes=[("آٹو فل", "اینڈرائیڈ کی آٹو فل سروس",
            "لاگ ان اور کارڈ فارمز آپ کے اندراجات براہ راست پیش کرتے ہیں۔ والٹ مقفل ہونے پر سسٹم کو کچھ نہیں ملتا — پہلے تالا کھولیں، پھر منتخب کریں۔"),
           ("کی بورڈ", "Sekuvo کی بورڈ",
            "کسی بھی ایپ میں اس پر سوئچ کریں اور محفوظ راز براہ راست فیلڈ میں ٹائپ کریں — تلاش کے ساتھ، حالیہ سب سے اوپر، بغیر کاپی کیے۔"),
           ("بلوٹوتھ", "آپ کے کمپیوٹر میں ٹائپ کرتا ہے",
            "آپ کا فون بلوٹوتھ کی بورڈ بن جاتا ہے اور راز کمپیوٹر کے کرسر پر ٹائپ کرتا ہے۔ کمپیوٹر پر کچھ بھی انسٹال نہیں ہوتا۔")],
    dl_eyebrow="Sekuvo حاصل کریں", dl_h2="مفت، اوپن سورس، GPLv3۔",
    dl_app_h="اینڈرائیڈ ایپ",
    dl_app_p="Google Play کی فہرست تیار ہو رہی ہے۔ تب تک آپ سورس سے بلڈ کر سکتے ہیں — ریپوزٹری کا README اسے دو کمانڈز میں بتاتا ہے۔",
    dl_tools_h="کمپیوٹر کی طرف کے ٹولز",
    dl_tools_p="کمپیوٹر کی طرف کا ٹول ایک ہی HTML فائل ہے — <code>aktar.html</code> — اور یہ ڈاؤن لوڈ ہے، ویب سائٹ نہیں: یہ مکمل طور پر آپ کی مشین پر چلتا ہے، اور یہ سائٹ آپ سے کبھی راز نہیں مانگتی۔",
    dl_tools_note="github.com → Releases · شائع شدہ SHA-256 چیک کریں",
...
P["ur"] = dict(
    title="Sekuvo — رازداری کی پالیسی",
    desc="Sekuvo کی رازداری کی پالیسی: کوئی ڈیٹا جمع نہیں کیا جاتا، کوئی ڈیٹا شیئر نہیں کیا جاتا، انٹرنیٹ کی اجازت موجود نہیں۔",
    h1="رازداری کی پالیسی",
    meta=f"ایپ: <strong>Sekuvo</strong> (com.sekuvo.app) · ڈویلپر: Ahmet Govercile · نفاذ کی تاریخ: {EFFECTIVE}",
    back="← sekuvo.com پر واپس",
    authoritative="یہ متن انگریزی اصل کا ترجمہ ہے۔ اختلاف کی صورت میں <a href=\"https://sekuvo.com/privacy/\">انگریزی ورژن</a> کو ترجیح حاصل ہے۔",
    sections=[
        ("خلاصہ",
         "<p><strong>Sekuvo کوئی ڈیٹا جمع، منتقل، یا شیئر نہیں کرتا۔</strong> یہ ایک آف لائن پاس ورڈ والٹ ہے۔ ایپ انٹرنیٹ کی اجازت نہیں مانگتی، اس لیے تکنیکی طور پر آپ کا ڈیٹا کہیں بھی نہیں بھیج سکتی۔</p>"),
        ("ڈیٹا کہاں محفوظ ہوتا ہے",
         "<p>عنوانات، صارف نام، پاس ورڈز، نوٹس، اور استعمال کی تاریخ سمیت جو کچھ آپ Sekuvo میں محفوظ کرتے ہیں وہ اس ڈیوائس پر رہتا ہے، آپ کے ماسٹر پاس ورڈ سے حاصل کردہ کلید سے مرمز۔ ایپ اس میں سے کچھ بھی کسی سرور پر اپ لوڈ، سنک، یا بیک اپ نہیں کرتی۔</p>"),
        ("ڈیٹا جمع کرنا اور شیئر کرنا",
         "<ul><li>کوئی ذاتی ڈیٹا جمع نہیں کیا جاتا۔</li><li>کوئی ڈیٹا تیسرے فریق کے ساتھ شیئر نہیں کیا جاتا۔</li><li>کوئی اینالیٹکس، اشتہاری، یا ٹریکنگ لائبریری شامل نہیں۔</li><li>ایپ استعمال کرنے کے لیے کسی اکاؤنٹ کی ضرورت نہیں۔</li></ul>"),
        ("اجازتیں",
         "<ul><li><strong>کیمرہ</strong> — صرف ان QR کوڈز کو اسکین کرنے کے لیے استعمال ہوتا ہے جنہیں آپ خود منتخب کرتے ہیں، تاکہ آپ اپنا ڈیٹا درآمد کر سکیں۔ تصاویر ڈیوائس پر پروسیس ہوتی ہیں اور کبھی اسے چھوڑ کر نہیں جاتیں۔</li><li><strong>بایومیٹرک</strong> — صرف آپ کی ڈیوائس پر، اینڈرائیڈ کے بایومیٹرک سسٹم کے ذریعے والٹ کا تالا کھولنے کے لیے استعمال ہوتی ہے۔ Sekuvo آپ کا فنگر پرنٹ یا چہرے کا ڈیٹا کبھی نہیں دیکھتا یا محفوظ نہیں کرتا۔</li><li><strong>بلوٹوتھ</strong> — صرف اس وقت استعمال ہوتا ہے جب آپ واضح طور پر Sekuvo سے قریبی کمپیوٹر پر پاس ورڈ ٹائپ کرنے کے لیے کہتے ہیں، بلوٹوتھ کی بورڈ کے طور پر کام کرتے ہوئے۔ صرف وہ حروف بھیجے جاتے ہیں جو آپ منتخب کرتے ہیں، براہ راست جوڑا شدہ ڈیوائس کو۔</li></ul>"),
        ("بیک اپس اور منتقلی",
         "<p>یہ صرف اسی وقت ہوتے ہیں جب آپ انہیں شروع کرتے ہیں، ایک مرمز شدہ فائل یا آپ کے متعین کردہ پاس ورڈ سے محفوظ QR کوڈز بناتے ہیں، اور صرف وہیں محفوظ یا ظاہر ہوتے ہیں جہاں آپ ہدایت کرتے ہیں۔ ایپ کبھی خود سے انہیں کہیں نہیں بھیجتی۔</p>"),
        ("بچے",
         "<p>Sekuvo کسی سے بھی ڈیٹا جمع نہیں کرتا، بشمول بچوں کے۔</p>"),
        ("تبدیلیاں",
