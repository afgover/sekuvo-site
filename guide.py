...
SHOTS = {
    ...
    "entries":   ["02-liste.png", "09-ekleme-menusu.png"],
    "channels":  ["03-detay.png"],
    "autofill":  ["06-ayarlar.png"],
    "quick":     ["11-duzenleme.png"],
    "backup":    ["07-yedekleme.png"],
    "transfer":  ["05-aktarim.png", "10-metinden-aktar.png"],
    "log":       ["08-gunluk.png"],
    "generator": ["04-uretici.png"],
}
...
CAPTIONS = {
    "en": {
        ...
        "09-ekleme-menusu.png": "Adding something: four entry types, plus the two import routes.",
        "03-detay.png": "An entry. The password stays masked; the icons beside each field copy it or type it into a computer.",
        "06-ayarlar.png": "Settings — where autofill and the keyboard are switched on.",
        "11-duzenleme.png": "Editing an entry. The quick-access switch sits at the bottom with its cost spelled out beside it.",
        "07-yedekleme.png": "Backup and restore live together in Settings.",
        "05-aktarim.png": "The wizard for bringing secrets over from a computer.",
        "10-metinden-aktar.png": "Importing an envelope pasted from a computer.",
        "08-gunluk.png": "The usage log: what went where and when — never the value itself.",
        "04-uretici.png": "The generator, with the resulting entropy shown in bits.",
    },
    "tr": {
        ...
        "09-ekleme-menusu.png": "Ekleme menüsü: dört kayıt türü ve iki içe aktarma yolu.",
        "03-detay.png": "Bir kayıt. Şifre maskeli kalır; her alanın yanındaki simgeler onu kopyalar ya da bilgisayara yazar.",
        "06-ayarlar.png": "Ayarlar — otomatik doldurma ve klavye buradan açılır.",
        "11-duzenleme.png": "Kayıt düzenleme. Hızlı erişim anahtarı altta, bedeli yanında yazılı.",
        "07-yedekleme.png": "Yedekleme ve geri yükleme Ayarlar'da yan yana durur.",
        "05-aktarim.png": "Bilgisayardan sır getirme sihirbazı.",
        "10-metinden-aktar.png": "Bilgisayardan yapıştırılan zarfın içe aktarılması.",
        "08-gunluk.png": "Kullanım günlüğü: ne nereye, ne zaman gitti — değerin kendisi asla.",
        "04-uretici.png": "Şifre üretici; sonucun entropisi bit olarak görünür.",
    },
    "es": {
        ...
        "09-ekleme-menusu.png": "Al añadir: cuatro tipos de entrada y las dos vías de importación.",
        "03-detay.png": "Una entrada. La contraseña sigue oculta; los iconos junto a cada campo la copian o la escriben en un ordenador.",
        "06-ayarlar.png": "Ajustes — desde aquí se activan el autocompletado y el teclado.",
        "11-duzenleme.png": "Editando una entrada. El interruptor de acceso rápido está abajo, con su coste explicado al lado.",
        "07-yedekleme.png": "Copia y restauración conviven en Ajustes.",
        "05-aktarim.png": "El asistente para traer secretos desde un ordenador.",
        "10-metinden-aktar.png": "Importando un sobre pegado desde el ordenador.",
        "08-gunluk.png": "El registro de uso: qué fue a dónde y cuándo — nunca el valor.",
        "04-uretici.png": "El generador, con la entropía resultante en bits.",
    },
    "hi": {
        ...
        "09-ekleme-menusu.png": "कुछ जोड़ते समय: चार एंट्री प्रकार और दो आयात रास्ते।",
        "03-detay.png": "एक एंट्री। पासवर्ड ढका रहता है; हर फ़ील्ड के पास के आइकन उसे कॉपी करते हैं या कंप्यूटर में टाइप करते हैं।",
        "06-ayarlar.png": "सेटिंग्स — ऑटोफ़िल और कीबोर्ड यहीं से चालू होते हैं।",
        "11-duzenleme.png": "एंट्री संपादित करते हुए। त्वरित पहुँच का स्विच नीचे है, उसकी क़ीमत साथ में लिखी है।",
        "07-yedekleme.png": "बैकअप और पुनर्स्थापना सेटिंग्स में साथ-साथ रहते हैं।",
        "05-aktarim.png": "कंप्यूटर से राज़ लाने का सहायक।",
        "10-metinden-aktar.png": "कंप्यूटर से चिपकाए गए लिफ़ाफ़े का आयात।",
        "08-gunluk.png": "उपयोग लॉग: क्या कहाँ और कब गया — मान कभी नहीं।",
        "04-uretici.png": "पासवर्ड जनरेटर, परिणामी एन्ट्रॉपी बिट में।",
    },
    "ar": {
        ...
        "09-ekleme-menusu.png": "عند الإضافة: أربعة أنواع من المدخلات، وطريقتا الاستيراد.",
        "03-detay.png": "مدخلة. تبقى كلمة المرور محجوبة؛ والأيقونات بجوار كل حقل تنسخه أو تكتبه في حاسوب.",
        "06-ayarlar.png": "الإعدادات — ومنها يُفعَّل الملء التلقائي ولوحة المفاتيح.",
        "11-duzenleme.png": "تحرير مدخلة. مفتاح الوصول السريع في الأسفل، وثمنه مكتوب بجانبه.",
        "07-yedekleme.png": "النسخ الاحتياطي والاستعادة معًا في الإعدادات.",
        "05-aktarim.png": "معالج جلب الأسرار من حاسوب.",
        "10-metinden-aktar.png": "استيراد مظروف مُلصق من الحاسوب.",
        "08-gunluk.png": "سجل الاستخدام: ما الذي ذهب وإلى أين ومتى — لا القيمة نفسها أبدًا.",
        "04-uretici.png": "مولّد كلمات المرور، وتظهر الإنتروبيا الناتجة بالبتّات.",
    },
}
